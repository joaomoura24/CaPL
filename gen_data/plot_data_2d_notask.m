%% load data
%--------------------------------------------------------------------------
load('../data/data_2d_notask_2sec_50traj_40datasets.mat');
...
fileID = fopen('../data/data_2d_notask_local_models_centers.dat','w');
...
nn = length(print_names);
fileID = fopen('../data/data_2d_notask_grid_ground_truth_policy.dat','w');
fprintf(fileID, formatSpec("%7s",",",nn), print_names{:});
fprintf(fileID, formatSpec("%7.3f",",",nn), print_data);
fclose(fileID);
%--------------------------------------------------------------------------
...
nn = length(print_names);
fileID = fopen('../data/data_2d_notask_samples.dat','w');
fprintf(fileID, formatSpec("%7s",",",nn), print_names{:});
fprintf(fileID, formatSpec("%7.3f",",",nn), print_data);
fclose(fileID);
%--------------------------------------------------------------------------
...
nn = length(print_names);
fileID = fopen('../data/data_2d_notask_grid_learned_policy.dat','w');
